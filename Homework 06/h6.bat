...
@echo "running BrobInt tests [if there are any, for EC]....."
echo "running BrobInt tests [if there are any, for EC]....." >> testresults.txt
...
java BrobIntTester1 >> testresults.txt
echo . >> testresults.txt
echo . >> testresults.txt
