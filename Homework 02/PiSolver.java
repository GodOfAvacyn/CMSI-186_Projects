...
public class PiSolver {
	public static void main(String[] args) {
		...
		*/
		...
		//This checks if the argument entered is even an integer in the first place.
		if (args.length > 0) { 
			try {
				numberThrown = Integer.parseInt(args[0]);
			} catch (NumberFormatException ex) {
				System.out.println("Whoops! The value you have entered isn't an integer....");
				System.out.println("We'll just input the number...oh, say... one thousand.");
			}

		}
		//This checks if our number thrown is valid; if it is zero or negative, it is invalid.
		if (numberThrown <= 0) {
			System.out.println("Whoops! The value you have entered is not positive....");
			System.out.println("We'll just input the number...oh, say... one thousand.");
			numberThrown = 1000;
		}
